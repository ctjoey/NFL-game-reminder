        ...
        NavigationStack {
            Form {
                ...
                Section("Delivery") {
                    ...
                    Text("A banner only stays a few seconds — that is iOS, not the app. Pull down on one to read it in full, or find it later in Notification Center. To make banners wait for you, open iOS Settings → Notifications → GameDial and set Banner Style to Persistent.")
