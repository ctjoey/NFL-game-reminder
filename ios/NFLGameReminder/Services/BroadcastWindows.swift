...
enum BroadcastWindows {
    ...
    private static let rules: [String: [String: Rule]] = [
        "CBS": ["SUN_EARLY": .init(minutes: 60, show: "The NFL Today", confidence: .stable),
                "SUN_LATE": .init(minutes: 5, show: "The NFL Today (late-window update; station already in NFL coverage)", confidence: .stable),
                "*": .init(minutes: 60, show: "CBS pregame", confidence: .typical)],
        "FOX": ["SUN_EARLY": .init(minutes: 120, show: "FOX NFL Kickoff (11:00 ET), then FOX NFL Sunday (12:00 ET)", confidence: .stable),
                "SUN_LATE": .init(minutes: 5, show: "FOX NFL Sunday (late-window update; station already in NFL coverage)", confidence: .stable),
        ...
        "NBC": ["SNF": .init(minutes: 80, show: "Football Night in America", confidence: .stable),
                "KICKOFF": .init(minutes: 80, show: "NFL Kickoff pregame / Football Night in America", confidence: .typical),
        ...
        "Peacock": ["*": .init(minutes: 80, show: "Football Night in America (simulcast)", confidence: .typical)],
        ...
        "ABC": ["MNF": .init(minutes: 15, show: "ABC joins MNF coverage (Countdown is on ESPN)", confidence: .typical),
